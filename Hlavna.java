...
public class Hlavna {
	...
	static int pocetKriz = 100 - pocetMut;
	...
	public static int trasa(Gen tmp) {
	...
	public static void mutacie(int poradie) {
		...
		int pocetMutagenov = rand.nextInt(pocetGenov) + 1;
		int poziciaGenu = rand.nextInt(pocetGenov) + 1;
		int druhM = rand.nextInt(2) + 1;

		for (int c = 0; c < pocetMutagenov; c++) {

			generacia.get(poradie).geny.get(poziciaGenu).rozhodnutie = rand.nextInt(4) + 1;

			if (druhM == 1) {
				generacia.get(poradie).geny.get(poziciaGenu).zaciatok = rand.nextInt(44) + 1;
			}

			druhM = rand.nextInt(2) + 1;
			poziciaGenu = rand.nextInt(pocetGenov) + 1;
	...
	public static Jedinec krizenie(int poradie1, int poradie2) {
		...
		int pocetZmien = rand.nextInt(pocetGenov) + 1;
		int poziciaGenu = rand.nextInt(pocetGenov) + 1;
	...
	public static void main(String[] args) {
		...
		// System.out.println(pole[zacy][zacx]);
